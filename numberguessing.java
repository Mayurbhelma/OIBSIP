...
public class numberguessing{
    public static void  main(String args[]){
        ...
        System.out.println();
        System.out.println("A number has been choosen between 1 to 100.Guess that number within 5 tries :");
        while(play.equals("yes")){
            ...
            // we get 5 tries because of loop which will run 5 times as per conditions.
            for(i=1;i<=k;i++){
                System.out.println();
                System.out.print("Chance "+i+": Guess the numnber :");
                guess=sc.nextInt();
                if(number==guess){
            ...
            // if we can't able to guess the correct number then we came out from the loop after 5 tries.
            if(i==k+1){
                System.out.println("You have used all 5 tries :");
